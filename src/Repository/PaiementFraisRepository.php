...
class PaiementFraisRepository extends ServiceEntityRepository
{
    ...
    public function add(PaiementFrais $entity, bool $flush = false): void
    {
    ...
    public function remove(PaiementFrais $entity, bool $flush = false): void
    {
...
//    /**
//     * @return PaiementFrais[] Returns an array of PaiementFrais objects
//     */
...
//    public function findOneBySomeField($value): ?PaiementFrais
//    {
//        return $this->createQueryBuilder('p')
//            ->andWhere('p.exampleField = :val')
//            ->setParameter('val', $value)
