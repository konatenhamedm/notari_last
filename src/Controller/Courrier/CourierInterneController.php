...
#[Route('/ads/courrier/courier/interne')]
class CourierInterneController extends BaseController
{
    const INDEX_ROOT_NAME = 'app_courrier_courier_interne_index';

    #[Route('/', name: 'app_courrier_courier_interne_index', methods: ['GET', 'POST'])]
    public function index(Request $request, DataTableFactory $dataTableFactory): Response
    {
        ...
        $table = $dataTableFactory->create()
            ...
            ->setName('dt_app_courrier_courier_interne');
        if ($permission != null) {
                        ...
                        $options = [
                            ...
                            'actions' => [
                                'edit' => [
                                    ...
                                    'url' => $this->generateUrl('app_courrier_courier_interne_edit', ['id' => $value]), 'ajax' => true, 'icon' => '%icon% bi bi-pen', 'attrs' => ['class' => 'btn-default'], 'render' => $renders['edit']
                                ],
                                'show' => [
                                    'url' => $this->generateUrl('app_courrier_courier_interne_show', ['id' => $value]), 'ajax' => true, 'icon' => '%icon% bi bi-eye', 'attrs' => ['class' => 'btn-primary'], 'render' => $renders['show']
                                ],
                                'delete' => [
                                    'target' => '#exampleModalSizeNormal',
                                    'url' => $this->generateUrl('app_courrier_courier_interne_delete', ['id' => $value]), 'ajax' => true, 'icon' => '%icon% bi bi-trash', 'attrs' => ['class' => 'btn-main'], 'render' => $renders['delete']
                                ],
                                'archive' => [
                                    'url' => $this->generateUrl('app_courrier_courier_interne_archive', ['id' => $value]), 'ajax' => true, 'icon' => '%icon% bi bi-file', 'attrs' => ['class' => 'btn-dark', 'title' => 'Archive'], 'render' => new ActionRender(function () use ($renders) {
                                ...
                                'accuse' => [
                                    'target' => '#exampleModalSizeSm2',
                                    'url' => $this->generateUrl('courier_accuse_interne', ['id' => $value]),
                                    'ajax' => true,
        ...
        return $this->render('courrier/courier_interne/index.html.twig', [
            'datatable' => $table,
    ...
    #[Route('/archive/{id}/interne', name: 'app_courrier_courier_interne_archive', methods: ['GET', 'POST'])]
    public  function  archive($id, DocumentCourierRepository $documentCourierRepository)
    {


        return $this->render('courrier/courier_interne/archive.html.twig', [
            'titre' => 'Arrive',
    ...
    #[Route('/new', name: 'app_courrier_courier_interne_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager, FormError $formError): Response
    {
        ...
        $form = $this->createForm(CourierArriveType::class, $courierArrive, [
            ...
            'action' => $this->generateUrl('app_courrier_courier_interne_new')
        ]);
        ...
        return $this->renderForm('courrier/courier_interne/new.html.twig', [
            'courier_interne' => $courierArrive,
            'form' => $form,
        ]);
    }

    #[Route('/{id}/show', name: 'app_courrier_courier_interne_show', methods: ['GET'])]
    public function show(CourierArrive $courierArrive): Response
    {
        return $this->render('courrier/courier_interne/show.html.twig', [
            'courier_interne' => $courierArrive,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_courrier_courier_interne_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, CourierArrive $courierArrive, EntityManagerInterface $entityManager, FormError $formError): Response
    {
        ...
        $form = $this->createForm(CourierArriveType::class, $courierArrive, [
            ...
            'type' => 'autre',
            'validation_groups' => $validationGroups,
            'action' => $this->generateUrl('app_courrier_courier_interne_edit', [
        ...
        return $this->renderForm('courrier/courier_interne/edit.html.twig', [
            'courier_interne' => $courierArrive,
            'form' => $form,
        ]);
    }

    #[Route('/{id}/delete', name: 'app_courrier_courier_interne_delete', methods: ['DELETE', 'GET'])]
    public function delete(Request $request, CourierArrive $courierArrive, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createFormBuilder()
            ->setAction(
                $this->generateUrl(
                    'app_courrier_courier_interne_delete',
                    [
                        'id' => $courierArrive->getId()
                    ]
                )
        ...
        return $this->renderForm('courrier/courier_interne/delete.html.twig', [
            'courier_interne' => $courierArrive,
            'form' => $form,
        ]);
    }
    ...
    #[Route('/existe', name: 'existeinterne', methods: ['POST', 'GET'])]
    ...
    #[Route('/accuse/{id}', name: 'courier_accuse_interne', methods: ['POST', 'GET'])]
    public function accuse(Request $request, CourierArrive $courierArrive, EntityManagerInterface $em): Response
    {
        ...
        $form = $this->createForm(CourierArriveType::class, $courierArrive, [
            ...
            'type' => 'accuse',
            'validation_groups' => $validationGroups,
            'action' => $this->generateUrl('courier_accuse_interne', [
                'id' => $courierArrive->getId(),
            ])
        ]);
        ...
        return $this->render('courrier/courier_interne/accuse.html.twig', [
