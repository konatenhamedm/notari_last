...
class Client
{
    ...
    public function addPiece(DocumentClient $documentClient): static
    {
        if (!$this->pieces->contains($documentClient)) {
            $this->pieces->add($documentClient);
            $documentClient->setClient($this);
        }
    ...
    public function removePiece(DocumentClient $documentClient): static
    {
        if ($this->pieces->removeElement($documentClient)) {
            // set the owning side to null (unless already changed)
            if ($documentClient->getClient() === $this) {
                $documentClient->setClient(null);
            }
