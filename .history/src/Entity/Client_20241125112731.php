...
class Client
{
    ...
    #[ORM\OneToMany(mappedBy: 'clients', targetEntity: Identification::class)]
    private Collection $identifications;

    #[ORM\OneToMany(mappedBy: 'client', targetEntity: PaiementFrais::class)]
    ...
    public function __construct()
    {
        ...
        $this->calenda = new ArrayCollection();
