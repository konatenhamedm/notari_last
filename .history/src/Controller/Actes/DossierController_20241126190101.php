 ...
 */
    ...
    public function piece(
       ...
       /* dd($dossier->getPieces()); */
        ...
        $attributs = ''; // Récupération du dossier depuis le repository ou autre méthode

// Vérifier si la collection d'identifications n'est pas vide
if (!$dossier->getIdentifications()->isEmpty()) {
    foreach ($dossier->getIdentifications() as $identification) {
        // Accéder aux données de chaque identification
        echo "Identification ID: " . $identification->getId() . PHP_EOL;
        echo "Attribut: " . $identification->getAttribut() . PHP_EOL;

        // Si besoin, accéder au client lié
        $client = $identification->getClients();
        if ($client !== null) {
            echo "Client Name: " . $client->getName() . PHP_EOL; // Exemple
        }
    }
}

        dd($dossier->getAttribut());
 ...
 */
    ...
    #[Route('/dossier/{id}/redaction', name: 'acte_vente_redaction', methods: ['GET', 'POST', 'PUT'])]
    ...
    #[Route('/{id}/remise', name: 'acte_vente_remise', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}/obtention', name: 'acte_vente_obtention', methods: ['GET', 'POST'])]
    public function obtention(
     ...
     #[Route('/{id}/remise-acte', name: 'acte_vente_remise_acte', methods: ['GET', 'POST'])]
