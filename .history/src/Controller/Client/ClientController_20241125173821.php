...
class ClientController extends BaseController
{
    ...
    public function newLoad(Request $request, Client $client, $typeClient, TypeClientRepository $typeClientRepository, EntityManagerInterface $entityManager, FormError $formError): Response
    {
