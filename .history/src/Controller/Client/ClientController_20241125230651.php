...
class ClientController extends BaseController
{
    ...
    public function newLoad(Request $request, TypeClient $typeClient, TypeClientRepository $typeClientRepository, EntityManagerInterface $entityManager, FormError $formError, Security $security, DocumentTypeClientRepository $documentTypeClientRepository): Response
    {
