...
class ClientController extends BaseController
{
    ...
    public function newLoad(Request $request,typecLI $typeClient, TypeClientRepository $typeClientRepository, EntityManagerInterface $entityManager, FormError $formError, Security $security, DocumentTypeClientRepository $documentTypeClientRepository): Response
    {
