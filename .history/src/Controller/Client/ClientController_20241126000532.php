...
class ClientController extends BaseController
{
                        ...
                        $options = [
                            ...
                            'actions' => [
                                'edit' => [
                                    ...
                                    'url' => $this->generateUrl('app_client_client_edit', ['id' => $value]),
                                    'ajax' => true,
                                    'icon' => '%icon% bi bi-pen',
                                ...
                                'show' => [
                                    'url' => $this->generateUrl('app_client_client_show', ['id' => $value]),
                                    'ajax' => true,
                                    'icon' => '%icon% bi bi-eye',
                                ...
                                'delete' => [
                                    ...
                                    'url' => $this->generateUrl('app_client_client_delete', ['id' => $value]),
                                    'ajax' => true,
    ...
    #[Route('/{id}/edit', name: 'app_client_client_edit', methods: ['GET', 'POST'], options: ['expose' => true])]
    ...
    #[Route('/edit/load/{typeClient}', name: 'app_client_client_edit_load', methods: ['GET', 'POST'], options: ['expose' => true])]
    public function newLoad(Request $request, Client $client, TypeClient $typeClient, TypeClientRepository $typeClientRepository, EntityManagerInterface $entityManager, FormError $formError, DocumentTypeClientRepository $documentTypeClientRepository): Response
    {
        ...
        return $this->renderForm('client/client/edit_load.html.twig', [
            'client' => $client,
            'form' => $form,
            'typeClient' => $typeClient,
