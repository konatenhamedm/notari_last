...
class ClientController extends BaseController
{
    ...
    public function newLoad(Request $request,Clien $typeClient, TypeClientRepository $typeClientRepository, EntityManagerInterface $entityManager, FormError $formError, Security $security, DocumentTypeClientRepository $documentTypeClientRepository): Response
    {
