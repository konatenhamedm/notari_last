...
class ClientController extends BaseController
{
    ...
    public function newLoad(Request $request, $typeClient, TypeClientRepository $typeClientRepository, EntityManagerInterface $entityManager, DocumentTypeClientRepository $documentTypeClientRepository,FormError $formError): Response
    {
