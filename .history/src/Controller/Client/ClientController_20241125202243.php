...
class ClientController extends BaseController
{
    ...
    public function newLoad(Request $request, Client $client, TypeClient $typeClient, TypeClientRepository $typeClientRepository, EntityManagerInterface $entityManager, DocumentTypeClientRepository $documentTypeClientRepository, FormError $formError): Response
    {
