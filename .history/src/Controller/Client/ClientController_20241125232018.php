...
class ClientController extends BaseController
{
    ...
    #[Route('/{id}/edit/load/{typeClient}', name: 'app_client_client_edit_load', methods: ['GET', 'POST'], options: ['expose' => true])]
    public function newLoad(Request $request,Client $client, TypeClient $typeClient, TypeClientRepository $typeClientRepository, EntityManagerInterface $entityManager, FormError $formError, Security $security, DocumentTypeClientRepository $documentTypeClientRepository): Response
    {
