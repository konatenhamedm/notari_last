...
class Menu
{
    ...
    public function listeGroupe()
    {
        $array = [
            ...
            'app_config_parametre_client_index' => 'Gestion des clients',//gestion des clients
            'app_client_client_index'=>'Liste des clients(Particuliers et entreprises)',
            'app_config_parametre_dossier_index' => 'Gestion des actes',//gestion des actes
            'app_acte_dossier_index' => 'En cours de traitement et Finalisés',//sous menu de cl
            'app_dossier_archive_index'=>'Liste des dossiers archivés',//sous menu de cl
