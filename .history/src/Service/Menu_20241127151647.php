...
class Menu
{
    ...
    public function listeGroupe()
    {
        $array = [
            ...
            'app_parametre_conservation_index'=>'Liste des conservations',//gestion des conver
            'app_config_parametre_client_index' => 'Liste des clients',
            'app_client_client_index'=>'Liste des clients(Particuliers et entreprises)',
            'app_config_parametre_dossier_index' => 'Liste des actes',
            'app_acte_dossier_index' => 'En cours de traitement et Finalisés',
            'app_dossier_archive_index'=>'Liste des dossiers archivés',
            'app_acte_acte_index' => 'Liste des actes',
            'app_acte_acte_constitution_index' => 'Liste des acte_constitutions',
            'app_acte_type_acte_index' => 'Liste des types d\'actes',
